...
<div class="col-md-12">
		...
		<div class="dm_breadcrumbs"><span class="breadcrumbs first">Wydarzenia - archiwum</span><span class="breadcrumbsBold last"></span></div>
...
<ul>
	...
	<?php 
		...
		foreach( $myposts as $post ) {
			...
			$full = get_thumb();
			$thumb = "timthumb.php?src=".$full."&w=138&h=144";			
